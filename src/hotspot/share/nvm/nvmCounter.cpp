...
unsigned long NVMCounter::_handshake_requested_threads_g = 0;
unsigned long NVMCounter::_handshake_answered_threads_g = 0;
...
void NVMCounter::entry(DEBUG_ONLY(Thread* cur_thread)) {
  ...
  _handshake_count = 0;
  _handshake_requested_threads = 0;
  _handshake_answered_threads = 0;
...
void NVMCounter::exit(DEBUG_ONLY(Thread* cur_thread)) {
  ...
  _handshake_count = 0;
  _handshake_requested_threads_g += _handshake_requested_threads;
  _handshake_requested_threads = 0;
  _handshake_answered_threads_g += _handshake_answered_threads;
  _handshake_answered_threads = 0;
...
void NVMCounter::print() {
  ...
  tty->print_cr(NVMCOUNTER_PREFIX "_handshake_requested_threads_g: %lu", _handshake_requested_threads_g);
  tty->print_cr(NVMCOUNTER_PREFIX "_handshake_answered_threads_g: %lu", _handshake_answered_threads_g);
  ...
  tty->print_cr(NVMCOUNTER_PREFIX "no barrier count: %lu", _n_no_barrier.load());
  ...
  tty->print_cr(NVMCOUNTER_PREFIX "verification fail: %ld\n", _n_fail.load());
}
